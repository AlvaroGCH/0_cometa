public class Departamento {
    ...
    //inecesarios
    private GrupoMiembros operarios;
    private GrupoMiembros coordinadores;
    private GrupoMiembros responsables;
    private GrupoMiembros subdirectores;
    private GrupoMiembros directores;
    ...
    Departamento(String funOperario, String funCoordinador, String funSubDirector, String funResponsable , String funDirector){
        this.grupos[0] = this.operarios = new GrupoMiembros(funOperario, ID_OPERARIO, 27);
        this.grupos[1] = this.coordinadores = new GrupoMiembros(funCoordinador, ID_COORDINADOR, 9);
        this.grupos[2] = this.responsables = new GrupoMiembros(funResponsable, ID_RESPONSABLE, 3);
        this.grupos[3] = this.subdirectores = new GrupoMiembros(funSubDirector, ID_SUBDIRECTOR, 1);
        this.grupos[4] = this.directores = new GrupoMiembros(funDirector, ID_DIRECTOR, 1);
